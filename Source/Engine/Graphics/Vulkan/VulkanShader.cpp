...
namespace Alimer
{
	namespace
	{
		[[nodiscard]] constexpr ShaderStage ConvertShaderStage(SpvExecutionModel model)
		{
			switch (model)
			{
	...
	VulkanShader::VulkanShader(VulkanGraphics& device_, ShaderStage stage_, const std::vector<uint8_t>& byteCode_, const std::string& entryPoint_)
