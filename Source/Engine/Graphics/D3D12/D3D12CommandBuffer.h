...
namespace Alimer
{
	...
	private:
		...
		D3D12_RENDER_PASS_RENDER_TARGET_DESC rtvDescs[kMaxSimultaneousRenderTargets] = {};
		D3D12_CPU_DESCRIPTOR_HANDLE colorRTVHandles[kMaxSimultaneousRenderTargets] = {};
		D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_SUBRESOURCE_PARAMETERS subresourceParameters[kMaxSimultaneousRenderTargets] = {};
